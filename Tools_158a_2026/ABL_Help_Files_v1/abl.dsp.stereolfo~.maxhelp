        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "Expanded independent help for abl.dsp.stereolfo~: Noise / drumLoop.aif source demo, wet/dry monitoring, original Max 9 examples, parameter-connected control/state capture, 24 editable message presets, and machine-independent local addressing. 6 exposed attribute control(s) found in the supplied help source."
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.dsp.stereolfo/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.dsp.stereolfo/preset 1  →  [recall $1]  →  stored slot",
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Values from 0. to 1. compress the start of the waveform and stretch the end."
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Values from -1. to 0. stretch the start of the waveform and compress the end."
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Changing the duty cycle introduces warping in the waveform. "
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "abl.dsp.stereolfo~ 0.5 @duty 0.3"
                                                }
                                            }
                                        ],
                                        "lines": [
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "The global phase of the LFO determines the starting phase when abl.dsp.stereolfo~ receives a reset message."
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Phase can be set as the second argument to the object, from the second inlet, or by an attribute"
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "reset and observe the starting point of the waveform"
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "abl.dsp.stereolfo~ 0.5 45 @waveform 5"
                                                }
                                            },
                                            {
                                                "box": {
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js duty waveform phase stereophase spin enablespin",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::duty",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::waveform",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::phase",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::stereophase",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "stereophase",
                            "parameter_shortname": "stereophase",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "stereophase_control"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::spin",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_stereolfo::enablespin",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "enablespin",
                            "parameter_shortname": "enablespin",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "enablespin_control",
                    "hidden": 1
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.dsp.stereolfo~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.dsp.stereolfo~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.dsp.stereolfo] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.dsp.stereolfo~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d3",
                    "maxclass": "comment",
                    "text": "ATTRIBUTES FOUND IN SUPPLIED HELP (6)",
                    "fontface": 1,
                    "fontsize": 13.0,
                    "patching_rect": [
                        24.0,
            ...
            },
            {
                "box": {
                    "id": "da1",
                    "maxclass": "comment",
                    "text": "waveform — address: waveform <value>",
                    "patching_rect": [
                        34.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da2",
                    "maxclass": "comment",
                    "text": "phase — address: phase <value>",
                    "patching_rect": [
                        354.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da3",
                    "maxclass": "comment",
                    "text": "stereophase — address: stereophase <value>",
                    "patching_rect": [
                        354.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da5",
                    "maxclass": "comment",
                    "text": "enablespin — address: enablespin <value>",
                    "patching_rect": [
                        674.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.dsp.stereolfo     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        558.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_dsp_stereolfo::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        644.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: duty, phase, stereo, basic. Direct object messages detected in source: duty -0.8, duty 0.75, reset. Source file: abl.dsp.stereolfo~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        710.0,
                        970.0,
