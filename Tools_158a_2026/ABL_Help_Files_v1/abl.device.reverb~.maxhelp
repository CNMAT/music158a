        ...
        "boxes": [
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.device.reverb/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.device.reverb/preset 1  →  [recall $1]  →  stored slot",
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js decay predelay mix damping",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_reverb::decay",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_reverb::predelay",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_reverb::mix",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_reverb::damping",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.device.reverb~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.device.reverb~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.device.reverb] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.device.reverb~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "da1",
                    "maxclass": "comment",
                    "text": "predelay — address: predelay <value>",
                    "patching_rect": [
                        34.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.device.reverb     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        558.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_device_reverb::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        644.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: basic. Direct object messages detected in source: (none detected as direct message boxes). Source file: abl.device.reverb~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        710.0,
                        970.0,
