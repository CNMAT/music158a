        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "Expanded independent help for abl.dsp.distortion~: Noise / drumLoop.aif source demo, wet/dry monitoring, original Max 9 examples, parameter-connected control/state capture, 24 editable message presets, and machine-independent local addressing. 7 exposed attribute control(s) found in the supplied help source."
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.dsp.distortion/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.dsp.distortion/preset 1  →  [recall $1]  →  stored slot",
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js sub midfreq mix gain mid bass treble",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::sub",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::midfreq",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::mix",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::gain",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::mid",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::bass",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_distortion::treble",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.dsp.distortion~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.dsp.distortion~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.dsp.distortion] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.dsp.distortion~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "da6",
                    "maxclass": "comment",
                    "text": "treble — address: treble <value>",
                    "patching_rect": [
                        674.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.dsp.distortion     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        576.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_dsp_distortion::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        662.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: basic. Direct object messages detected in source: (none detected as direct message boxes). Source file: abl.dsp.distortion~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        728.0,
                        970.0,
