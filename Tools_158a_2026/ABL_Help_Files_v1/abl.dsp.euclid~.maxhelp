        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "Expanded independent help for abl.dsp.euclid~: Noise / drumLoop.aif source demo, wet/dry monitoring, original Max 9 examples, parameter-connected control/state capture, 24 editable message presets, and machine-independent local addressing. 6 exposed attribute control(s) found in the supplied help source."
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.dsp.euclid/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.dsp.euclid/preset 1  →  [recall $1]  →  stored slot",
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "You can apply two transformer effects (in series) to the modulator and get the output from the right outlet. The left outlet will remain \"dry\" of these modulation effects."
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "abl.dsp.euclid~ 1. @steps 0.5 @pulses 0.8 @fx1_type 1 @fx1 0.4 @fx2_type 10 @fx2 0.2",
                                                    "varname": "abl.dsp.euclid~_AA"
                                                }
                                            },
                                            {
                                                "box": {
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "presentation_linecount": 2,
                                                    "text": "Using an external phasor overrides the internal one"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "The value is expected to be normalized to the range [3, 16]"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": ";\rmax launchbrowser https://en.wikipedia.org/wiki/Euclidean_rhythm"
                                                }
                                            },
                                            {
                                                "box": {
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js pulses steps fx2 fx1 fx2_type fx1_type",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::pulses",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::steps",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::fx2",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::fx1",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::fx2_type",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "fx2_type",
                            "parameter_shortname": "fx2_type",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "fx2_type_control",
                    "hidden": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_dsp_euclid::fx1_type",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "fx1_type",
                            "parameter_shortname": "fx1_type",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "fx1_type_control",
                    "hidden": 1
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.dsp.euclid~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.dsp.euclid~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.dsp.euclid] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.dsp.euclid~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "da0",
                    "maxclass": "comment",
                    "text": "pulses — address: pulses <value>",
                    "patching_rect": [
                        34.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da1",
                    "maxclass": "comment",
                    "text": "steps — address: steps <value>",
                    "patching_rect": [
                        34.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da4",
                    "maxclass": "comment",
                    "text": "fx2_type — address: fx2_type <value>",
                    "patching_rect": [
                        674.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da5",
                    "maxclass": "comment",
                    "text": "fx1_type — address: fx1_type <value>",
                    "patching_rect": [
                        674.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.dsp.euclid     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        558.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_dsp_euclid::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        644.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: fx, basic. Direct object messages detected in source: (none detected as direct message boxes). Source file: abl.dsp.euclid~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        710.0,
                        970.0,
