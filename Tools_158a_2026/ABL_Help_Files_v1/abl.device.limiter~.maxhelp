        ...
        "boxes": [
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.device.limiter/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.device.limiter/preset 1  →  [recall $1]  →  stored slot",
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Channel link sets how much gain reduction is shared across the two channels. At 0, the two channels are completely unlinked. At 1, limiting is applied to both channels whenever either requires compression."
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "In Left/Right mode, the left and right signals are compressed independently.\n\nIn Mid/Side mode, the signal is encoded to mid/side before limiting and decoded to stereo at the output. This can be useful for preserving the dynamics of stereo signals."
                                                }
                                            },
                                            {
                                                "box": {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "text": "With @maximize on, lowering @threshold reduces the dynamic range and increases the loudness of the signal."
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "abl.device.limiter~ @maximize 1"
                                                }
                                            },
                                            {
                                                "box": {
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js link release ceiling gain routing threshold output maximize lookahead mode",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::link",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::release",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::ceiling",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::gain",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::routing",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::threshold",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::output",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::maximize",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "maximize",
                            "parameter_shortname": "maximize",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "maximize_control",
                    "hidden": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::lookahead",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_limiter::mode",
                    "parameter_enable": 1,
                    "patching_rect": [
                        -200.0,
                        -200.0,
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.device.limiter~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.device.limiter~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.device.limiter] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.device.limiter~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "da1",
                    "maxclass": "comment",
                    "text": "release — address: release <value>",
                    "patching_rect": [
                        34.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da2",
                    "maxclass": "comment",
                    "text": "ceiling — address: ceiling <value>",
                    "patching_rect": [
                        34.0,
                        516.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da5",
                    "maxclass": "comment",
                    "text": "threshold — address: threshold <value>",
                    "patching_rect": [
                        354.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da7",
                    "maxclass": "comment",
                    "text": "maximize — address: maximize <value>",
                    "patching_rect": [
                        354.0,
                        534.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da8",
                    "maxclass": "comment",
                    "text": "lookahead — address: lookahead <value>",
                    "patching_rect": [
                        674.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.device.limiter     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        594.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_device_limiter::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        680.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: routing, maximize, basic. Direct object messages detected in source: (none detected as direct message boxes). Source file: abl.device.limiter~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        746.0,
                        970.0,
