        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "Expanded independent help for abl.device.channeleq~: Noise / drumLoop.aif source demo, wet/dry monitoring, original Max 9 examples, parameter-connected control/state capture, 24 editable message presets, and machine-independent local addressing. 4 exposed attribute control(s) found in the supplied help source."
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "route preset /abl.device.channeleq/preset",
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "preset 1  OR  /abl.device.channeleq/preset 1  →  [recall $1]  →  stored slot",
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "abl.device.channeleq~ -20. 3. 800 -12"
                                                }
                                            },
                                            {
                                                "box": {
            ...
            },
            {
                "box": {
                    "id": "x_statejs",
                    "maxclass": "newobj",
                    "text": "js abl_parameter_state.js midgain highgain midfreq lowgain",
                    "numinlets": 2,
                    "numoutlets": 1,
                    "outlettype": [
                        ""
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_channeleq::midgain",
                    "parameter_enable": 1,
                    "patching_rect": [
                        304.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_channeleq::highgain",
                    "parameter_enable": 1,
                    "patching_rect": [
                        393.0,
                        220.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "highgain",
                            "parameter_shortname": "highgain",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "highgain_control"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_channeleq::midfreq",
                    "parameter_enable": 1,
                    "patching_rect": [
                        477.0,
                        220.0,
            ...
            },
            {
                "box": {
                    ...
                    "param_connect": "abl_device_channeleq::lowgain",
                    "parameter_enable": 1,
                    "patching_rect": [
                        562.0,
                        220.0,
                    ...
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_longname": "lowgain",
                            "parameter_shortname": "lowgain",
                            "parameter_modmode": 0,
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    "varname": "lowgain_control"
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    "id": "ap_title",
                                    "maxclass": "comment",
                                    "text": "abl.device.channeleq~ — ALL ADDRESSABLE ATTRIBUTES",
                                    "fontsize": 18.0,
                                    "fontface": 1,
                                    "patching_rect": [
                                        20.0,
                            ...
                            },
                            {
                                "box": {
                                    "id": "ap_note",
                                    "maxclass": "comment",
                                    "text": "Each attrui uses a local abl.device.channeleq~ instance for Max-supplied type/range handling and also sends the same selector/value message to [s abl.device.channeleq] in the parent help file.",
                                    "patching_rect": [
                                        20.0,
                                        50.0,
                                        850.0,
            ...
            },
            {
                "box": {
                    "id": "d2",
                    "maxclass": "comment",
                    "text": "The complete original Max 9 help patch is embedded via the top-right ORIGINAL MAX 9 HELP / EXAMPLES subpatch and can be opened without an external file. The red abl.device.channeleq~ instance is the parameter/state target. Parameter-aware controls use param_connect; address and preset messages reach that same object through the local router.",
                    "patching_rect": [
                        24.0,
                        410.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d3",
                    "maxclass": "comment",
                    "text": "ATTRIBUTES FOUND IN SUPPLIED HELP (4)",
                    "fontface": 1,
                    "fontsize": 13.0,
                    "patching_rect": [
                        24.0,
            ...
            },
            {
                "box": {
                    "id": "da0",
                    "maxclass": "comment",
                    "text": "midgain — address: midgain <value>",
                    "patching_rect": [
                        34.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da1",
                    "maxclass": "comment",
                    "text": "highgain — address: highgain <value>",
                    "patching_rect": [
                        34.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da2",
                    "maxclass": "comment",
                    "text": "midfreq — address: midfreq <value>",
                    "patching_rect": [
                        354.0,
                        480.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "da3",
                    "maxclass": "comment",
                    "text": "lowgain — address: lowgain <value>",
                    "patching_rect": [
                        354.0,
                        498.0,
                        300.0,
            ...
            },
            {
                "box": {
                    "id": "d5",
                    "maxclass": "comment",
                    "text": "Local address:  r / s  abl.device.channeleq     •     parameter syntax: <attribute> <value>     •     preset syntax: preset <1–24>",
                    "patching_rect": [
                        34.0,
                        558.0,
                        960.0,
            ...
            },
            {
                "box": {
                    "id": "d8",
                    "maxclass": "comment",
                    "text": "Primary and hidden tracking controls connect to abl_device_channeleq::<attribute>. On load, the supplier reports its factory parameter state; the help patch applies mix 1.0 when available, captures the state, and stores it cleanly into PRESET 1 without requiring a machine-specific path.",
                    "patching_rect": [
                        24.0,
                        644.0,
                        970.0,
            ...
            },
            {
                "box": {
                    "id": "d10",
                    "maxclass": "comment",
                    "text": "Embedded original tabs: basic. Direct object messages detected in source: (none detected as direct message boxes). Source file: abl.device.channeleq~.maxhelp.",
                    "patching_rect": [
                        24.0,
                        710.0,
                        970.0,
