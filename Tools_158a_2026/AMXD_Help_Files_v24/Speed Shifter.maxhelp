  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Two tape-loop-like delay channels use independent speed, length and feedback settings for pitch-shifting, doubling and feedback textures."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Left Length, Right Length, Left Feedback."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Specifies the length of the left tape loop."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Specifies the length of the right tape loop."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Determines the amount of the left tape loop fed back into\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets output signal level at which clipping occurs in the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Determines the amount of the right tape loop fed back into\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets speed of the left tape loop, specified as a\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets speed of the right tape loop, specified as a\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Left Length and Right Length."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Speed Shifter.amxd in the same folder, or drag Speed Shifter.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /speedshifter/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /speedshifter/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "left_speed 100, left_length 1011., wet/dry 100., right_speed 100, left_feedback 50., feedback_clipping 50., right_length 1111., right_feedback 50.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Speed Shifter."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s speedshifter]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Speed Shifter \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: left_speed <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: left_length <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: right_speed <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: feedback_clipping <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-36",
         "maxclass": "newobj",
         "text": "prepend feedback_clipping",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: right_length <value>"
        }
       },
       {
        "box": {
