  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "A stereo panning and amplitude-modulation effect with waveform, rate, spread, phase and synchronization controls."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Waveform, Spread, Sync."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Lets you change the shape of the tremolo continuously, from a sine\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets stereo spread of the output."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets synchronization mode."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Waveform and Spread."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 4 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Tremellow.amxd in the same folder, or drag Tremellow.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /tremellow/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /tremellow/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "sync 0., wet/dry 100., spread 62.991982, waveform 1.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Tremellow."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s tremellow]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Tremellow \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         "id": "obj-12",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=internal | 1=live",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          142.0,
       ...
       },
       {
        "box": {
         "id": "obj-29",
         "maxclass": "comment",
         "text": "freq_range \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          242.0,
       ...
       },
       {
        "box": {
         "id": "obj-30",
         "maxclass": "comment",
         "text": "phase \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          262.0,
       ...
       },
       {
        "box": {
         "id": "obj-31",
         "maxclass": "comment",
         "text": "mod_freq_range \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          282.0,
       ...
       },
       {
        "box": {
         "id": "obj-32",
         "maxclass": "comment",
         "text": "sync_division \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          302.0,
       ...
       },
       {
        "box": {
         "id": "obj-33",
         "maxclass": "comment",
         "text": "fine_freq \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          322.0,
       ...
       },
       {
        "box": {
         "id": "obj-34",
         "maxclass": "comment",
         "text": "frequency \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          342.0,
       ...
       },
       {
        "box": {
         "id": "obj-35",
         "maxclass": "comment",
         "text": "mod_freq \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          362.0,
       ...
       },
       {
        "box": {
         "id": "obj-36",
         "maxclass": "comment",
         "text": "amount \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          382.0,
       ...
       },
       {
        "box": {
         "id": "obj-37",
         "maxclass": "comment",
         "text": "amount_range \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          402.0,
