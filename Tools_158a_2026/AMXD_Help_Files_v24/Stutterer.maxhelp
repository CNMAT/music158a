  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Captures short fragments of incoming audio and repeats, reverses and pitch-shifts them manually or automatically."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include DefaultPitch, Left Freeze, Trigger."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Controls synchronization behavior."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore DefaultPitch and Left Freeze."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 1 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Stutterer.amxd in the same folder, or drag Stutterer.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /stutterer/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /stutterer/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Portamento 50, sync 1., wet_dry 100., note_length 3., ranger 64, auto_trig 0., density 50, stutters 8, lMulti 0",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Stutterer."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s stutterer]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Stutterer \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Portamento <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: note_length <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-27",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 21  0=1nd | 1=1n | 2=1nt | 3=2nd | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          244.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: defaultPitch <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: auto_trig <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: reverse <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-42",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 2  0=L | 1=forward | 2=reverse",
         "fontsize": 8.5,
         "patching_rect": [
          876.0,
          142.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: trigger <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: stutters <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: left_freeze <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-64",
         "maxclass": "comment",
         "text": "note \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          378.0,
       ...
       },
       {
        "box": {
         "id": "obj-66",
         "maxclass": "comment",
         "text": "Multiplier \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          418.0,
       ...
       },
       {
        "box": {
         "id": "obj-67",
         "maxclass": "comment",
         "text": "stutter_time \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          438.0,
       ...
       },
       {
        "box": {
         "id": "obj-68",
         "maxclass": "comment",
         "text": "lMulti \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          458.0,
