  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Splits the signal into low, mid and high bands and gives each band its own stereo delay, feedback and gain path."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Effect Gain, Direct Gain, Low Gain."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables this processing function."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Effect Gain and Direct Gain."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Max DelayMultiBand.amxd in the same folder, or drag Max DelayMultiBand.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /maxdelaymultiband/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /maxdelaymultiband/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "LowXFreq 1000, EffectGain 0., HighDelL 0, MidFB 0, LowEnable 1., LowDelR 0, HighEnable 1., HighGain 0., MidDelR 0, HighXFreq 4000, MidGain 0., HighDelR 0, MidDelL 0, LowDelL 0, HighFB 0, MidEnable 1., DirectGain -70., Lowgain 0., LowFB 0",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Max DelayMultiBand."
    }
   },
   {
    "box": {
     "id": "obj-111",
     "maxclass": "message",
     "text": "/maxdelaymultiband/preset 1",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s maxdelaymultiband]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max DelayMultiBand \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LowXFreq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EffectGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighDelL <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MidFB <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LowEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LowDelR <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MidDelR <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighXFreq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MidGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighDelR <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MidDelL <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LowDelL <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: HighFB <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MidEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DirectGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Lowgain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LowFB <value>"
        }
       },
       {
        "box": {
