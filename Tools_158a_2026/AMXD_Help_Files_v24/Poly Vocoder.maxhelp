  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Polyphonic Retune Vocoder"
    }
   },
   {
    "box": {
     ...
     "text": "A polyphonic retune~-based vocoder/harmonizer supporting chord patterns, stereo spread and optional MIDI-driven pitches."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Correction Amount, Correction Threshold, Chord."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of the correction applied. 0 means no correction, 100\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets threshold at which the correction takes effect."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets sibilance threshold at which the original signal is passed through\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets automatic bypass when the signal contains too much noise or\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of stereo spreading for the current chord."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets a fade time in milliseconds that occurs when\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "When turned on, auto-attenuates the effect's level\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "When turned on, compensates the latency of the pitch\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Correction Amount and Correction Threshold."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 19 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Poly Vocoder.amxd in the same folder, or drag Poly Vocoder.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /polyvocoder/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /polyvocoder/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Atten 1, AmbienceThreshold 0, Bus 0, Quality 0., Latency 1, PreGain 0., CorrectionAmount 100, Fade 1000, Shift 0., CorrectionThreshold 0, Spread 50, Pattern 0., Gain 0., Midi 0., Dry/Wet 100., Chord 57, SibilanceThreshold 100, Storage \"{'pattrstorage': {'name': 'u953001153', 'slots': {'2': {'id': 2, 'data': {'Chord': [57, 18, 60, 18, 64, 18, 67, 22]}}}}}\"",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Poly Vocoder."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s polyvocoder]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Poly Vocoder \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: AmbienceThreshold <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-16",
         "maxclass": "newobj",
         "text": "prepend AmbienceThreshold",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: CorrectionAmount <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: CorrectionThreshold <value>"
        }
       },
       {
        "box": {
         "id": "obj-55",
         "maxclass": "newobj",
         "text": "route CorrectionThreshold",
         "numinlets": 1,
         "numoutlets": 2,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-56",
         "maxclass": "newobj",
         "text": "prepend CorrectionThreshold",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: InitSettings <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: SibilanceThreshold <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-96",
         "maxclass": "newobj",
         "text": "prepend SibilanceThreshold",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
