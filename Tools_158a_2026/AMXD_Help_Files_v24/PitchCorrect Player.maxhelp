  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Pitch/Formant-Correcting Player"
    }
   },
   {
    "box": {
     ...
     "text": "A stereo/dual-mono sample player with pitch correction, formant control, looping and playback-region controls."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables pitch correction."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets pitch correction quality."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables pitch and formant correction."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets basic tuning in Herz."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Click here to select the entire audio."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Correction slur time in milliseconds."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Drag to zoom vertical audio's view in and out."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Drag to zoom horizontal audio's view in and out."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 18 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and PitchCorrect Player.amxd in the same folder, or drag PitchCorrect Player.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pitchcorrectplayer/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pitchcorrectplayer/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Loop 1, Quality 0., Correct 1, ZoomV 0, Rev 0, Fade 5, Slur 0, Sync 0, Thru 1, Formant 1, Pitch 1, Tuning 440, Play 0, Gain 0., ZoomH 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for PitchCorrect Player."
    }
   },
   {
    "box": {
     "id": "obj-111",
     "maxclass": "message",
     "text": "/pitchcorrectplayer/preset 1",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pitchcorrectplayer]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "PitchCorrect Player \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         "id": "obj-17",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 2  0=basic | 1=good | 2=better",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          176.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Correct <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Slur <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Tuning <value>"
        }
       },
       {
        "box": {
