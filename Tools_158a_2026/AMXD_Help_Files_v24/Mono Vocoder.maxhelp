  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Monophonic Retune Vocoder"
    }
   },
   {
    "box": {
     ...
     "text": "Uses retune~ to force a monophonic input toward a selected or MIDI-derived pitch, with dedicated pitch-correction controls."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Pitch, Correction Amount, Correction Threshold."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Adjusts pitch in cents (100 cents = 1 semitone)."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Pitch and Correction Amount."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Mono Vocoder.amxd in the same folder, or drag Mono Vocoder.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /monovocoder/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /monovocoder/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "AmbienceThreshold 0, Bus 0, Quality 0., Detune 0, Latency 1, CorrectionAmount 100, Glide 50, CorrectionThreshold 0, Pitch 60., Gain 0., Midi 0., Dry/Wet 100., SibilanceThreshold 100",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Mono Vocoder."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s monovocoder]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Mono Vocoder \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Detune <value>"
        }
       },
       {
        "box": {
