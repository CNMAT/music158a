  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Stereo Dynamics Processor"
    }
   },
   {
    "box": {
     ...
     "text": "A stereo compressor/limiter interface built around omx.comp~, exposing mastering-oriented dynamics and detector controls."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "audio input  \u2192  level detection  \u2192  compression / limiting / gain control  \u2192  output"
    }
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Expander Threshold, Thresh, Ratio."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Downward Expander: A noise gate is effective for reducing background\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Threshold: Specifies where the unity-point of the compressor should be."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Ratio: Specifies the compression ratio, between 1:1 and Infinite:1."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sidechain Filter: A selectable Sidechain Filter filters out part of\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Range: Specifies the maximum amount of gain amplification allowed."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Dual Band: The Compressor can be used in either wideband or dual band\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Attack: Signify \"rate\", not \"time\"."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Release: Signify \"rate\", not \"time\"."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Progressive Release: At higher settings, the compressor\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Smoothing: Applies a low-pass filter to the control signal."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Rate of output metering in milliseconds"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sidechain Delay: An adjustable Sidechain Delay enables you\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Internal Presets: These presets are to be considered\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Expander Threshold and Thresh."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 21 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Max Compressor.amxd in the same folder, or drag Max Compressor.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "AGC (\"Automatic Gain Control\") on/off"
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /maxcompressor/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /maxcompressor/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Mode 0, LevelDetectGating -36, Range 20, SideChainFilter 0., ProgressiveRelease 50, AGC 1, Delay 23, Preset 0, ChannelCoupling 0, Release 111, Meters 0., Gain 0., Attack 133, DownExpandThresh -45, DownExpandEnable 1, DualBand 0., Ratio 100, Limiter 1, SmoothGain 65, MetersRate 25, Bypass 0., LevelDetectFreeze -54, Thresh -10",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Max Compressor."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s maxcompressor]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max Compressor \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-12",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=punchy | 1=smooth",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          142.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LevelDetectGating <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-16",
         "maxclass": "newobj",
         "text": "prepend LevelDetectGating",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Range <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: SideChainFilter <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: ProgressiveRelease <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-31",
         "maxclass": "newobj",
         "text": "prepend ProgressiveRelease",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: AGC <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Delay <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Preset <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-47",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 4  0=Guitar | 1=Bass | 2=Vocal | 3=Drums | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          380.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: ChannelCoupling <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-52",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 2  0=Stereo | 1=Left | 2=Right",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          414.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Release <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Meters <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Attack <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DownExpandThresh <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DownExpandEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DualBand <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Ratio <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Limiter <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: SmoothGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MetersRate <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Bypass <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-112",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=No bypass | 1=Bypass",
         "fontsize": 8.5,
         "patching_rect": [
          876.0,
          414.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: LevelDetectFreeze <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-116",
         "maxclass": "newobj",
         "text": "prepend LevelDetectFreeze",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Thresh <value>"
        }
       },
       {
        "box": {
