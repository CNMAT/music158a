  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "A four-tap stereo delay whose tap times are moved by ramp oscillators, producing chorus, rhythmic delay and shifting spatial patterns."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Frequency, Phase Spread, Delay Left."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Master rate of tap delay time movements."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of difference between the initial phases of the delay times."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets delay offset (before modulation) of the left delay."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets delay offset (before modulation) of the right delay."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets difference between the delay time window sizes."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets master range of delay times."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of silence between left delay time ramps."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets difference between the delay time modulation\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Frequency and Phase Spread."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Pendulum.amxd in the same folder, or drag Pendulum.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of silence between right delay time ramps."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pendulum/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pendulum/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "spacing_right 1., wet_dry 100., \"delay left\" 0., master_window 623., phase_spread 0., frequency 6., spacing_left 1., freq_spread 0.25, window_spread 0.12, \"delay right\" 317.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Pendulum."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pendulum]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pendulum \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: spacing_right <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: delay left <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: master_window <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: phase_spread <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: frequency <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: spacing_left <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: freq_spread <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: window_spread <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: delay right <value>"
        }
       },
       {
        "box": {
