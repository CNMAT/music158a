  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Clipping / Low-Pass Distortion"
    }
   },
   {
    "box": {
     ...
     "text": "Applies extreme input gain and clipping followed by resonant low-pass filtering for aggressive distortion and animated timbral motion."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Input Drive, Filter Cutoff, Filter Resonance."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets scaling factor by which the input is multiplied before it is\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets cutoff frequency of a filter that occurs after clipping."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets resonance of the lowpass filter that occurs after clipping."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets an offset value to be applied to the high value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets an offset value to be applied to the low value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets rate of modulation of the upper value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of modulation of the upper value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets rate of modulation of the lower value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of modulation of the lower value of the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets balance of the uncrunched and crunched output\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Input Drive and Filter Cutoff."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 10 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and MonsterCrunch.amxd in the same folder, or drag MonsterCrunch.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /monstercrunch/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /monstercrunch/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "lowpass-resonance 0.66, low-freq-depth 55., \"Initial Gain\" 54., hi-freq-offset 0.78, wet-dry 100., filter-cutoff 2075., low-freq-offset 0.42, level 0., hi-mod-freq 1., hi-freq-depth 197., low-mod-freq 4.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for MonsterCrunch."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s monstercrunch]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "MonsterCrunch \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: lowpass-resonance <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "newobj",
         "text": "prepend lowpass-resonance",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: low-freq-depth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Initial Gain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: hi-freq-offset <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: filter-cutoff <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: low-freq-offset <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: hi-mod-freq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: hi-freq-depth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: low-mod-freq <value>"
        }
       },
       {
        "box": {
