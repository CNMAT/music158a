  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Polyphonic Pitch Harmonizer"
    }
   },
   {
    "box": {
     ...
     "text": "A polyphonic pitch shifter that creates multi-note harmonizations with chord patterns, stereo spread and optional MIDI control."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Chord, Quality, Vibrato Enable."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets pitch which the incoming audio will be forced to."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Turns vibrato effect on and off."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets depth of the vibrato in cents."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables cyclic vibrato."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of cyclic vibrato."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables a MIDI input bus through which MIDI notes can be conveyed into\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Selects a MIDI input bus through which MIDI notes can be conveyed into\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets rate of the vibrato in Herz."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables random vibrato."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of random vibrato."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of stereo spreading for the current\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Edit a chord, then switch to another pattern by clicking\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets direction of the vibrato, either up & down, up or down."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Chord and Quality."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 22 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Multi Harmonizer.amxd in the same folder, or drag Multi Harmonizer.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets a global transposition (in cents) applied to the\u2026"
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /multiharmonizer/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /multiharmonizer/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Atten 1, VibDepth 25., VibOscAmount 50, Bus 0, Quality 0., Latency 1, PreGain -3, VibDirection 0., VibOscEnable 1., Fade 1000, Shift 0., VibEnable 0., VibRate 4., Spread 50, VibNoiseAmount 50, Pattern 0., Gain 0., Midi 0., Dry/Wet 100., Chord 57, VibNoiseEnable 0., Storage \"{'pattrstorage': {'name': 'u332000353', 'slots': {}}}\"",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Multi Harmonizer."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s multiharmonizer]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Multi Harmonizer \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Atten <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibDepth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibOscAmount <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Bus <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-27",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 11  0=1 | 1=2 | 2=3 | 3=4 | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          244.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: PreGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibDirection <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-47",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 2  0=updown | 1=up | 2=down",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          380.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibOscEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Shift <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibRate <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibNoiseAmount <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Pattern <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Midi <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Clear <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: VibNoiseEnable <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-114",
         "maxclass": "comment",
         "text": "Chord \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          548.0,
       ...
       },
       {
        "box": {
         "id": "obj-115",
         "maxclass": "comment",
         "text": "Storage \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          568.0,
