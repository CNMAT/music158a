  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Monophonic Pitch Analysis"
    }
   },
   {
    "box": {
     ...
     "text": "Tracks monophonic pitch with retune~, provides a monitoring synthesizer, and can convert estimated pitch and velocity into MIDI data."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "audio input  \u2192  analysis / detection stage  \u2192  visual or control representation  \u2192  output"
    }
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Tracking, Latency, Synth."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables pitch tracking."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables pitch detection synth feedback."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables a MIDI output bus through which MIDI notes that are being\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Selects a waveform for the synth."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Selects a MIDI output bus through which MIDI notes that are being\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Pitch & amplitude changes smoothing."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "When a note is played, the next note will be played after\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Selects an input channel to be analyzed."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Filter out notes that have a velocity below this threshold."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Better CPU performance can be obtained by using 16-bit\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls and observe the analysis.  4. Adjust Tracking and Latency while watching the display."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Pitch Tracker.amxd in the same folder, or drag Pitch Tracker.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pitchtracker/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pitchtracker/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "InGain 0, SynthGain 0., Bus 0, Latency 1, TimeThresh 10, 16bit 1, MinVel 10, Waveform 0., Channel 0, Smooth 10, Tracking 1, Gain 0., Midi 0., Dry/Wet 100., Synth 1.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Pitch Tracker."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pitchtracker]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pitch Tracker \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: InGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: SynthGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: TimeThresh <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: 16bit <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: MinVel <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Waveform <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-47",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 3  0=sine | 1=saw | 2=tri | 3=square",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          380.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Channel <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Smooth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Tracking <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Flush <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Synth <value>"
        }
       },
       {
        "box": {
