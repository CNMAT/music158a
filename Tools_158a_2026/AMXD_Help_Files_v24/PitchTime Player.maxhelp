  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Time/Pitch-Correcting Player"
    }
   },
   {
    "box": {
     ...
     "text": "A stereo/dual-mono sample player with independent pitch/time correction, formant handling and region/loop playback controls."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Choose, Play, Loop."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables looping playback."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets time stretching factor."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables pitch & time parameters."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Synchronizes playback with either Live or Max's transport\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 23 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and PitchTime Player.amxd in the same folder, or drag PitchTime Player.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pitchtimeplayer/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pitchtimeplayer/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Loop 1, EnableTransp 1, ZoomV 0, Rev 0, Fade 5, Stretch 1, Sync 0, Thru 1, EnableFormant 1, Formant 0., Play 0, Gain 0., Transp 0., EnableStretch 1, PitchTime 1, ZoomH 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for PitchTime Player."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pitchtimeplayer]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "PitchTime Player \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Loop <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Sync <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: PitchTime <value>"
        }
       },
       {
        "box": {
