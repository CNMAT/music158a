  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Envelope-Driven Delay / Distortion"
    }
   },
   {
    "box": {
     ...
     "text": "Uses the input's average amplitude to drive gain and delay time, producing level-dependent filtering, pitch modulation and distortion."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Drive, Factor, Averaging Mode."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Gain on the input signal before it is averaged."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets a factor by which the average signal amplitude value is\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets mode used to compute the average amplitude value of the signal."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets whether the average signal amplitude value is multiplied or\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Applies an exponential function to the input signal, which changes the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets time interval over which the input signal is averaged."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Multiplies the Averaging Delay by a scaling factor."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Drive and Factor."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Mangle Filter.amxd in the same folder, or drag Mangle Filter.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /manglefilter/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /manglefilter/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "wet_dry 100., delay_range 1., scalling_mode 0., input_curve 2., delay 0, drive 4.32, averaging_mode 2., factor 100.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Mangle Filter."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s manglefilter]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Mangle Filter \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: delay_range <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: scalling_mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-22",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=multiply | 1=divide",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          210.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_curve <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: drive <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: averaging_mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-42",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 2  0=bipolar | 1=absolute | 2=rms",
         "fontsize": 8.5,
         "patching_rect": [
          876.0,
          210.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: factor <value>"
        }
       },
       {
        "box": {
