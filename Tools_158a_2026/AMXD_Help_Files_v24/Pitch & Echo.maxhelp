  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Feedback Pitch-Shift Delay"
    }
   },
   {
    "box": {
     ...
     "text": "Places a pitch shifter inside a feedback delay so each repeat can be transposed again, producing rising or falling harmonizer patterns."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Transpose, Quality, Vibrato Enable."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables echo effect."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Switch delay time mode between absolute milliseconds and\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets delay time in milliseconds."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets delay time in note values, relatively to the global\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets direction of the vibrato, either up & down, up or\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Pitch & Echo.amxd in the same folder, or drag Pitch & Echo.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of audio re-injection into the delay line."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pitchecho/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pitchecho/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "VibDepth 25., VibOscAmount 50, EchoFeedback 50, Quality 0., Latency 1, VibDirection 0., VibOscEnable 1., EchoMode 0., EchoSync 13., Glide 50, VibEnable 0., VibRate 4., EchoTime 500, VibNoiseAmount 50, Gain 0., Transp 0., Dry/Wet 100., VibNoiseEnable 0., EchoEnable 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Pitch & Echo."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pitchecho]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pitch & Echo \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EchoFeedback <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EchoMode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EchoSync <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-52",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 20  0=1/128 | 1=1/64 | 2=1/32T | 3=1/64D | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          414.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EchoTime <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EchoEnable <value>"
        }
       },
       {
        "box": {
