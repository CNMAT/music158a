  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Microtonal Pitch Corrector"
    }
   },
   {
    "box": {
     ...
     "text": "A table-based microtonal pitch corrector with editable curved scales and support for importing Scala (.scl) tuning files."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Correction Amount, Correction Threshold, Quality."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Scale editor: click and release the mouse on a point to see where it is."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets tonic (fundamental) of the current scale."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Edit a scale, then switch to another pattern by clicking on another\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets number of points traversing the Scale table."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Enables/disables snap-to-grid."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Import Scala scale files (.scl)."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets grid resolution in cents."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Microtuner.amxd in the same folder, or drag Microtuner.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /microtuner/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /microtuner/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "AmbienceThreshold 0, SnapToGrid 1, Quality 0., Latency 1, CorrectionAmount 100, Tonic 11., CorrectionThreshold 0, Points 13., GridResol 100., Pattern 0., Gain 0., Dry/Wet 100., SibilanceThreshold 100, Scale 1200., Storage \"{'pattrstorage': {'name': 'u394000814', 'slots': {}}}\"",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Microtuner."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s microtuner]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Microtuner \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: SnapToGrid <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Tonic <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-37",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 11  0=B | 1=A# | 2=A | 3=G# | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          312.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: InitScale <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Points <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: GridResol <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Import <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-89",
         "maxclass": "comment",
         "text": "Scale \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          446.0,
