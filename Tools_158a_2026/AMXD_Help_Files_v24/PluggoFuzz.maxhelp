  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "A fuzz/distortion processor with four clipping modes plus multimode filters before and after the clipping stage."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "audio input  \u2192  nonlinear drive / shaping  \u2192  filtering or tone control  \u2192  output"
    }
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Intensity, Clip Mode, Input Filter Mode."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of distortion applied to the input signal. 1 is the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets distortion mode - Soft Clip, Hard Clip, Foldover, or Wrap."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Chooses the frequency-response characteristic of the input filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Chooses the frequency-response characteristic of the output filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets center or corner frequency of the input filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Adjusts output level of the filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets resonance or Q factor of the input filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets center or corner frequency of the output filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets resonance or Q factor of the output filter."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Boosts or attenuates the input signal before it enters the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Boosts or attenuates the final output signal."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Intensity and Clip Mode."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and PluggoFuzz.amxd in the same folder, or drag PluggoFuzz.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /pluggofuzz/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /pluggofuzz/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "input_filter_gain 1., intensity 3., output_filter_frequency[1] 652., input_filter_mode 0., output_filter_Q 0.5, clip_mode 0., output_filter_mode 6., level -2., output_filter_gain 0.5, input_filter_Q 0.5, input_filter_frequency 5824.5, input_gain 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for PluggoFuzz."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s pluggofuzz]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "PluggoFuzz \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_filter_gain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "newobj",
         "text": "prepend input_filter_gain",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: intensity <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-19",
         "maxclass": "message",
         "text": "output_filter_frequency[1] $1",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
         ...
         "hint": "Native amxd~ setter: output_filter_frequency[1] <value>"
        }
       },
       {
        "box": {
         "id": "obj-20",
         "maxclass": "newobj",
         "text": "route output_filter_frequency[1]",
         "numinlets": 1,
         "numoutlets": 2,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-21",
         "maxclass": "newobj",
         "text": "prepend output_filter_frequency[1]",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_filter_mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-26",
         "maxclass": "newobj",
         "text": "prepend input_filter_mode",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         "id": "obj-27",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 6  0=Low Pass | 1=High Pass | 2=Low Shelf | 3=High Shelf | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          244.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: output_filter_Q <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: clip_mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-37",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 3  0=Soft Clip | 1=Hard Clip | 2=Foldover | 3=Wrap",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          312.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: output_filter_mode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-41",
         "maxclass": "newobj",
         "text": "prepend output_filter_mode",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: output_filter_gain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-51",
         "maxclass": "newobj",
         "text": "prepend output_filter_gain",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_filter_Q <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_filter_frequency <value>"
        }
       },
       {
        "box": {
         "id": "obj-60",
         "maxclass": "newobj",
         "text": "route input_filter_frequency",
         "numinlets": 1,
         "numoutlets": 2,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-61",
         "maxclass": "newobj",
         "text": "prepend input_filter_frequency",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: input_gain <value>"
        }
       },
       {
        "box": {
