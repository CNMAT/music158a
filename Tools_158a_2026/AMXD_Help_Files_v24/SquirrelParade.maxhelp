  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Granular Cross-Modulation"
    }
   },
   {
    "box": {
     ...
     "text": "Splits the input into four granular channels whose playback speeds can frequency-modulate one another through a routing matrix."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "audio input capture  \u2192  grain / fragment engine  \u2192  pitch, timing and randomization  \u2192  stereo output"
    }
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Grain Size, Repeat, Dropout."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets percentage chance that the frequency-modulated granular output\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets percent chance that the output grains will be muted."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets cross-modulation depth for each granular voice."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets level for each granular voice."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets frequency in Hz of a test tone for the effect."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Turns the test tone on and off."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets playback rate for each granular voice."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets duration of a linear fade in/out at the beginning/end\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Specifies how widely the output is spread across the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Grain Size and Repeat."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 12 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and SquirrelParade.amxd in the same folder, or drag SquirrelParade.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /squirrelparade/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /squirrelparade/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "dropout 0., fmd4 0.12, bs_4 1., freq 440, wet/dry 100., grain_size 3056, v2 0., spread 27., window 0.27, v3 0., repeat 0., v4 0.25, fmd3 0.05, bs_3 0.02, fmd2 0.03, bs_2 0.02, v1 0.25, fmd1 0.17, bs_1 1.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for SquirrelParade."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s squirrelparade]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "SquirrelParade \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: dropout <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fmd4 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: bs_4 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: freq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: grain_size <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: v2 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: spread <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: window <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: v3 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: repeat <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: v4 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fmd3 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: bs_3 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fmd2 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: bs_2 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: test_01 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: v1 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fmd1 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: bs_1 <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-109",
         "maxclass": "comment",
         "text": "matrix4_4 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          514.0,
       ...
       },
       {
        "box": {
         "id": "obj-110",
         "maxclass": "comment",
         "text": "matrix3_4 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          534.0,
       ...
       },
       {
        "box": {
         "id": "obj-111",
         "maxclass": "comment",
         "text": "matrix2_3 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          554.0,
       ...
       },
       {
        "box": {
         "id": "obj-112",
         "maxclass": "comment",
         "text": "matrix1_2 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          574.0,
       ...
       },
       {
        "box": {
         "id": "obj-113",
         "maxclass": "comment",
         "text": "matrix3_3 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          594.0,
       ...
       },
       {
        "box": {
         "id": "obj-114",
         "maxclass": "comment",
         "text": "matrix2_2 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          614.0,
       ...
       },
       {
        "box": {
         "id": "obj-115",
         "maxclass": "comment",
         "text": "matrix1_1 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          634.0,
       ...
       },
       {
        "box": {
         "id": "obj-116",
         "maxclass": "comment",
         "text": "matrix4_3 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          654.0,
       ...
       },
       {
        "box": {
         "id": "obj-117",
         "maxclass": "comment",
         "text": "matrix3_2 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          674.0,
       ...
       },
       {
        "box": {
         "id": "obj-118",
         "maxclass": "comment",
         "text": "matrix2_1 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          694.0,
       ...
       },
       {
        "box": {
         "id": "obj-119",
         "maxclass": "comment",
         "text": "matrix4_2 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          714.0,
       ...
       },
       {
        "box": {
         "id": "obj-120",
         "maxclass": "comment",
         "text": "matrix3_1 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          734.0,
       ...
       },
       {
        "box": {
         "id": "obj-121",
         "maxclass": "comment",
         "text": "matrix1_4 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          754.0,
       ...
       },
       {
        "box": {
         "id": "obj-122",
         "maxclass": "comment",
         "text": "matrix4_1 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          774.0,
       ...
       },
       {
        "box": {
         "id": "obj-123",
         "maxclass": "comment",
         "text": "matrix2_4 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          794.0,
       ...
       },
       {
        "box": {
         "id": "obj-124",
         "maxclass": "comment",
         "text": "matrix1_3 \u2014 parameter type None; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          814.0,
