  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Envelope-Controlled Filter"
    }
   },
   {
    "box": {
     ...
     "text": "Maps an envelope follower derived from the input onto filter cutoff frequency, turning signal dynamics into automatic spectral motion."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Filter Type, Filter Gain, Filter Q."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Selects the processing mode or type."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets a frequency or frequency range."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Controls envelope follower."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Controls envelope sharpness."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Filter Type and Filter Gain."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Max AutoFilter.amxd in the same folder, or drag Max AutoFilter.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /maxautofilter/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /maxautofilter/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "FilterFreqOffset 50, EnvInput 0, EnvSharpness 0., EnvSmooth 50, FilterType 4., Dry/Wet 100., EnvInterval 50, FilterGain 0, FilterClear 0, EnvMode 0., FilterQ 1., FilterFreqRange 1000, EnvFollower 0, Gain 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Max AutoFilter."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s maxautofilter]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max AutoFilter \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FilterFreqOffset <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvInput <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvSharpness <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvSmooth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FilterType <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-32",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 7  0=lowpass | 1=highpass | 2=bandpass | 3=bandstop | \u2026",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          278.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvInterval <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FilterGain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvMode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FilterQ <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FilterFreqRange <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: EnvFollower <value>"
        }
       },
       {
        "box": {
