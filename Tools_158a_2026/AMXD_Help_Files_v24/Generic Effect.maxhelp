  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "A modulated comb filter that can be configured for vibrato, chorus, flanging and other delay-modulation effects."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Input Gain, Feedforward, Feedback."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Reduction in the gain of the undelayed input signal."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Base delay time before modulation of the feedforward delay."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Base delay time before modulation of the feedback delay."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "The level of the delayed input signal."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Frequency of modulation of the feedforward delay time."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Amount of modulation of the feedforward delay time."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Frequency of modulation of the feedback delay time."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Amount of modulation of the feedback delay time."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Input Gain and Feedforward."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Generic Effect.amxd in the same folder, or drag Generic Effect.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /genericeffect/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /genericeffect/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "feedback_gain 0., ff_mod_depth 0.95, wet/dry 100., fb_mod_depth 0., feedback 1., ff_mod_freq 3., fb_mod_freq 1., feedforward 3, Feedforward 1., input_gain 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Generic Effect."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s genericeffect]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Generic Effect \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: feedback_gain <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: ff_mod_depth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fb_mod_depth <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: ff_mod_freq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: fb_mod_freq <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: feedforward <value>"
        }
       },
       {
        "box": {
