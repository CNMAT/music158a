  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Fragment / Stutter Processor"
    }
   },
   {
    "box": {
     ...
     "text": "Records short fragments of the input and loops them forward or backward at variable speeds, combining stutter, pitch shift and digital artifacts."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Repetition, Direction, Declick."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets probability of reusing the previous playback buffer rather than\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets direction of playback speed."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "When On, an enveloped muting out of the output occurs when the buffer\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of random modulation of the amplitude, changed at a rate\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets size (in samples) of the buffer to be recorded and played back\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets probability that silence will be played back rather than the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets speed as a multiple of the original."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of the effect\u2019s output that is fed back to the\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Repetition and Direction."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 9 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Fragulator.amxd in the same folder, or drag Fragulator.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /fragulator/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /fragulator/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "\"buffer size\" 30., direction 0., \"drop out\" 0., \"amp variation\" 0., declick 0., repetition 0., \"Playback Speed\" 3.8, feedback 0., wet_dry 100.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Fragulator."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s fragulator]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Fragulator \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: buffer size <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: direction <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-17",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=forward | 1=reverse",
         "fontsize": 8.5,
         "patching_rect": [
          318.0,
          176.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: drop out <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: amp variation <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: declick <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: repetition <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Playback Speed <value>"
        }
       },
       {
        "box": {
