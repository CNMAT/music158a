  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Simulates moving-source Doppler effects by coordinating variable delay, amplitude and stereo position with optional tempo-synchronized motion."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include PositionMode, PositionFree, DistanceMin."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore PositionMode and PositionFree."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Max DopplerPan.amxd in the same folder, or drag Max DopplerPan.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /maxdopplerpan/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /maxdopplerpan/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "PositionMode 0, PositionFree 50, RateUnit 13., RateRand 0, Output 0., DistanceMax 25, Source -70., DistanceMin 5, RateMult 8.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Max DopplerPan."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s maxdopplerpan]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max DopplerPan \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: PositionMode <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Activate <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: PositionFree <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: RateUnit <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: RateRand <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Output <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DistanceMax <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: Source <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DistanceMin <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: RateMult <value>"
        }
       },
       {
        "box": {
