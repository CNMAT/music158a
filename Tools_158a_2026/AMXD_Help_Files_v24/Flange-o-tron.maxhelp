  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "A flanger whose delay and feedback are driven by step sequencers rather than conventional continuous LFO modulation."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Step Type, Flange Sequence, Steps."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Displays step sequencers for the low-frequency oscillator that varies\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Number of steps in the sequence when bar mode is selected."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets duration of one step in the sequence when the notes mode is\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Toggles between the delay and feedback step sequencer displays."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets amount of time it takes the delay and feedback\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "\u2022 The sync mode is set using a pop-up menu."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Displays the current tempo."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Reset lag range slider to full range."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Step Type and Flange Sequence."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Flange-o-tron.amxd in the same folder, or drag Flange-o-tron.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /flangeotron/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /flangeotron/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "step_len 13, wet/dry 100., flange_UI 1, steps 16, tempo 0., range_slider 0",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Flange-o-tron."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s flangeotron]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Flange-o-tron \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: step_len <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: steps <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: step_type[1] <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: view <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-52",
         "maxclass": "comment",
         "text": "ENUM  0 \u2026 1  0=delay | 1=feedback",
         "fontsize": 8.5,
         "patching_rect": [
          876.0,
          244.0,
       ...
       },
       {
        "box": {
         "id": "obj-54",
         "maxclass": "comment",
         "text": "flange_UI \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          344.0,
       ...
       },
       {
        "box": {
         "id": "obj-55",
         "maxclass": "comment",
         "text": "range_slider \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          364.0,
