  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Transfer-Curve Distortion"
    }
   },
   {
    "box": {
     ...
     "text": "Maps input amplitude through an editable transfer curve, allowing nonlinear distortion from subtle reshaping to extreme transformation."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include Copy Up, Copy Down, Null."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Copies the bottom half of the transfer curve to the top half."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Copies the top half of the transfer curve to the bottom half."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets curve to a straight, diagonal line, which passes the signal\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Averages each point on the curve with its neighbors, which\u2026"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore Copy Up and Copy Down."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Derived from the device's embedded comments, exposed parameter names and 5 unique parameter annotations."
    }
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Waveshaper.amxd in the same folder, or drag Waveshaper.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /waveshaper/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /waveshaper/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Waveshaper."
    }
   },
   {
    "box": {
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s waveshaper]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Waveshaper \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: copy_up <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: null <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: copy_down <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-29",
         "maxclass": "comment",
         "text": "wave \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          242.0,
