  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "An FFT-domain delay that provides independently shaped delay and feedback values across 256 spectral frequency bands."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Principal controls documented below include DelayRand, DelayRandStep, DelayRange."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "Sets the available delay-time range."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "1. Enable the test source.  2. Start DSP with startwindow.  3. Open the device controls.  4. Raise FINAL OUTPUT GAIN slowly from -65 dB.  5. Explore DelayRand and DelayRandStep."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "If the AMXD does not auto-load, keep this .maxhelp file and Max SpectralDelay.amxd in the same folder, or drag Max SpectralDelay.amxd directly onto the amxd~ object."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       ...
       },
       {
        "box": {
         "id": "obj-7",
         "maxclass": "newobj",
         "text": "route preset /maxspectraldelay/preset",
         "numinlets": 1,
         "numoutlets": 3,
         "outlettype": [
          "",
       ...
       },
       {
        "box": {
         "id": "obj-9",
         "maxclass": "comment",
         "text": "preset 1  OR  /maxspectraldelay/preset 1  \u2192  [recall $1]  \u2192  stored slot",
         "fontsize": 9.5,
         "patching_rect": [
          382.0,
          116.0,
       ...
       },
       {
        "box": {
         "id": "obj-11",
         "maxclass": "message",
         "text": "Delays 0.464844, Dry/Wet 100., Feedbacks 0.710938, DelayRange 2000., FeedbackRandStep 10, DelayRandStep 10, FeedbackRange 50., Gain 0.",
         "numinlets": 2,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External preset recall receive for Max SpectralDelay."
    }
   },
   {
    "box": {
     "id": "obj-111",
     "maxclass": "message",
     "text": "/maxspectraldelay/preset 1",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
     ...
     "hint": "Editable OSC-style preset recall. Change 1 to any slot 1\u201324 and click. For external control send the same message to [s maxspectraldelay]."
    }
   },
   {
    "box": {
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max SpectralDelay \u2014 Direct Parameter Messaging / Dynamic Tuning",
         "fontsize": 18.0,
         "fontface": 1,
         "patching_rect": [
          24.0,
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DelayRange <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FeedbackRandStep <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DelayRandStep <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FeedbackRange <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: FeedbackRand <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "hint": "Native amxd~ setter: DelayRand <value>"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-50",
         "maxclass": "comment",
         "text": "Feedbacks \u2014 parameter type 3; no numeric tuner generated.",
         "fontsize": 9.0,
         "patching_rect": [
          24.0,
          330.0,
